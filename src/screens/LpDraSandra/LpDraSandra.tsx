    ...
    return (
        <main className="bg-[#000000] min-h-screen w-full">
            ...
            <section className="w-full bg-cover bg-center min-h-screen bg-[url('./bg-fisio.png')]">
                <div className="mx-auto flex flex-col lg:flex-row items-center justify-between px-20 lg:px-32  gap-12 content-center absolute inset-0 bg-[#1c0f0a]/80 z-0">
                    <motion.div
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-[#fefaf4] text-[25px] font-semibold tracking-wide [font-family:'Recoleta-RegularDEMO',Helvetica]">
                                    SANDRA RODRIGUES
                                </div>
                        ...
                        <h1 className="max-w-[720px] text-5xl font-bold leading-snug [font-family:'Recoleta-RegularDEMO',Helvetica] text-[#fefaf4]">
                            Está buscando um atendimento{" "}
                            <span className="text-[#d4ba76]">fisioterapêutico humanizado</span> e de qualidade?
                        </h1>

                        <p className="max-w-[650px] text-[#fefaf4] text-2xl [font-family:'Recoleta-RegularDEMO',Helvetica]">
                        ...
                        <a
                            ...
                            className="flex items-center gap-3 h-[60px] px-8 py-3 rounded-lg text-[#532d18] text-lg font-bold [font-family:'Inter',Helvetica] bg-gradient-to-b from-[#f2deba] to-[#d4ba76] hover:brightness-110 transition"
                        >
                            <FaWhatsapp className="text-2xl" />
                            FALAR AGORA COM DRA. SANDRA RODRIGUES
                        </a>
                    </motion.div>
            ...
            <section className="w-full py-16 px-4 sm:px-6 md:px-20 bg-gradient-to-b from-[#2e1c14] via-[#3e2a1f] to-[#5c4033]">
                <motion.div
            ...
            <section
                className="w-full min-h-screen bg-gradient-to-r from-[#2e1c14] via-[#3e2a1f] to-[#5c4033] flex justify-center">
                <div className="max-w-7xl mx-auto flex flex-row lg:flex-row items-center justify-center gap-10">
                    <motion.div
                        initial={{opacity: 0, x: -50}}
                        whileInView={{opacity: 1, x: 0}}
                        transition={{duration: 0.8}}
                        viewport={{once: true}}
                        className="w-full lg:w-1/2 h-[600px] overflow-hidden rounded-3xl bg-[#7b4a2d] shadow-xl"
                    >
                        <img
                    ...
                    >
                        ...
                        <h2 className="text-4xl font-bold text-[#fefaf4] [font-family:'Open_Sans',Helvetica]">
                        ...
                        <div className="flex flex-col gap-4 mt-4">
                            <p className="text-[#f3e4c5] text-lg font-medium">
                            ...
                            <p className="text-[#f3e4c5] text-lg font-medium">Entre em contato e agende uma avaliação personalizada. Seu bem-estar começa com um passo.</p>
                        </div>


                        <a href="#"
                           className="mt-4 inline-block w-fit bg-[#d4ba76] hover:bg-[#c4a858] text-[#532d18] font-semibold px-6 py-3 rounded-full transition duration-300 shadow-sm hover:shadow-md text-sm md:text-base">
                            Saiba mais
                        </a>
                    </motion.div>
                </div>
                ...
                <div className="max-w-7xl mx-auto flex flex-col gap-10">
                    <div className="flex flex-wrap justify-between items-start gap-10">
                        <div className="flex flex-col gap-4">
                            <h4 className="font-bold text-xl">Fisioterapeuta | CREFITO: 161550-3</h4>

                            <a href="https://wa.me/5511939445414?text=Ol%C3%A1%2C%20Dra.%20Sandra!%20Encontrei%20seu%20site%20e%20gostaria%20de%20agendar%20um%20atendimento%20de%20fisioterapia."
                               target="_blank" rel="noopener noreferrer"
                               className="flex items-center gap-3 text-sm hover:underline text-[#fefaf4] hover:text-[#c4a858]">
                                <FaWhatsapp className="text-lg"/>(11) 93944-5414
                            </a>

                            <div className="flex items-center gap-3 cursor-pointer hover:underline hover:text-[#c4a858]"
                                 onClick={() => navigator.clipboard.writeText('sandramorais1968@icloud.com')}>
                                <FaEnvelope className="text-lg"/>
                                <span>sandramorais1968@icloud.com</span>
                                <FaRegCopy title="Clique para copiar" className="text-sm"/>
                            </div>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <a href="https://www.instagram.com/drasandrarodrigues_" target="_blank"
                               rel="noopener noreferrer"
                               className="flex items-center gap-2 hover:underline hover:text-[#c4a858]">
                                <FaInstagram className="text-lg"/> @drasandrarodrigues_
                            </a>
                        </div>
                        ...
                        <div>
                            <button
                                ...
                                className="flex items-center gap-2 mt-6 sm:mt-0 text-sm hover:text-[#c4a858]"
                            >
                            ...
                            <div className="pt-6">
                                <a href="#"
                                   className="text-base underline text-[#fefaf4] mt-2 flex flex-col hover:text-[#c4a858]">
                                    <span>Serviços</span>
                                </a>
                                <a href="#sobre"
                                   className="text-base underline text-[#fefaf4] mt-2 flex flex-col hover:text-[#c4a858]">
                    ...
                    <div
                        className="flex flex-col sm:flex-row justify-between items-center mt-6 border-t border-[#d2b48c] pt-6">
                        ...
                        <div className="text-sm text-right text-[#fefaf4]">
